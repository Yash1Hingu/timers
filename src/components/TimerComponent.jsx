...
const TimerComponent = () => {
    ...
    const audioRef = useRef(new Audio('src/assets/oversimplified-alarm-clock-113180.mp3')); // Use a ref to manage the audio element

    const addTimer = () => {
        setTimers([
            ...timers,
            { hours: 0, minutes: 0, seconds: 0, title: '', running: false, finished: false, intervalId: null }
        ]);
    };
